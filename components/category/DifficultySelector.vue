<template>
  <div class="difficultySection">
    ...
    <div class="buttonGroup" role="group" aria-label="Schwierigkeitsgrade">
      <NuxtLink v-for="difficulty in ['easy', 'medium', 'hard']" :key="difficulty" :to="getDifficultyPath(difficulty)"
        class="button" :aria-label="$t(`category.difficulty.${difficulty}.label`)">
