...
def sync_music_links() -> None:
    ...
    for de_file in german_files:
        ...
        de_entries_by_key = {
            (entry["artist"], entry["album"]): entry for entry in de_data
        }
                ...
                if key in de_entries_by_key:
                    ...
                    for field in fields_to_copy:
                        ...
                        if field in de_entry and de_entry[field]:
                            ...
                            if (
                                field not in target_entry
                                or target_entry[field] != de_entry[field]
                            ):
                    ...
                    if entry_changed:
                        ...
                        updated_count += 1
                        print(
                            f"Updated entry: {target_entry['artist']} - {target_entry['album']}"
                        )
