    ...
    <main class="min-h-screen w-full">
      <Transition name="slide" mode="out-in" class="motion-reduce:transition-none">
        ...
        >
          <h2 
            id="setup-title"
            class="mb-6 text-center text-xl font-bold leading-tight text-[var(--color-primary)] md:text-2xl"
          >
          ...
          <div class="mb-6 flex justify-center gap-4">
            <button
              ...
              :class="[
                ...
                'min-h-[44px] cursor-pointer rounded-md border border-[var(--color-primary)] px-4 py-2 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-primary)] focus-visible:ring-offset-2 motion-reduce:transition-none'
              ]"
          ...
          <div class="mb-6 flex flex-col gap-4">
            <div v-for="n in playerCount" :key="n" class="flex flex-col gap-2">
              ...
              <input
                ...
                class="min-h-[44px] rounded-md border border-[var(--color-surface-light)] bg-[var(--color-background)] px-3 py-2 text-base text-[var(--color-primary)] focus:border-[var(--color-primary)] focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)]"
                required
              />
            </div>
          </div>
